...
The automatic [Scene Builder](/tutorials/getting-started/scene-builder) ensures correct settings for the **Interaction** module, so you don't need to do anything yourself. 
...
![DistanceGrab](/img/vault/DistanceGrab.png)
...
![PhysicalGrab](/img/vault/PhysicalGrab.png)
...
![CustomGrabPoseButtons](/img/vault/CustomGrabPoseButtons.png)
...
**Grabbable Object** also attaches a [Highlight](/tutorials/additions/highlight) component. 
...
>Note: The GrabbableObject script automatically assigns a tag and a layer - "Grabbable" - do not change these as it will cause GrabbableObject to not work.
