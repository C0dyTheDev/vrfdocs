...
| Dependencies: | [Localization](/tutorials/modules/localization) [Platform](/tutorials/modules/platform) [Audio](/tutorials/modules/audio) |
| ------------- | --------------------------------------- |
...
**Education** processes only one **Step** at a time, making the process very controlled. **Testing** basically throws all the **Steps** of the **Block** at the user at once, so they can skip various steps and make **mistakes** in the process (for **Mistake** management, refer to the [Mistake Module](/tutorials/modules/mistake)).
...
![ScenarioExample](/img/vault/ScenarioExample.png)
...
![StartBlockSetting](/img/vault/StartBlockSetting.png)
