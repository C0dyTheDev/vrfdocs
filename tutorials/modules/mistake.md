...
**Mistake Module** is for tracking mistakes that the user makes during the app. It integrates with the [Minigame](/tutorials/modules/minigame) and [Platform](/tutorials/modules/platform) Module. 
...
![MistakesListExample](/img/vault/MistakesListExample.png)
...
**Display Name** is what gets displayed on the platform when [Platform Module](/tutorials/modules/platform) is configured. 
